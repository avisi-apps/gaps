(ns com.avisi-apps.gaps.reitit-express.middleware.content-negotiation.formats.json
  (:require [com.avisi-apps.gaps.reitit-express.middleware.content-negotiation.formats.core :as core]
            [goog.object :as gobj]
...
(def json-format (core/map->Format
